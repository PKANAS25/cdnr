        ...
        'fileToUpload'=>'image|max:615|mimes:jpeg,jpg',]); 
          ...
          $contact = new Contact(array( 
                ...
                if($request->file('fileToUpload') && $contactId)
                {
                 ...
                 Image::make($request->file('fileToUpload'))->save('../public_html/uploads/contactPics/'.$imageName); 
                } 
   ...
   public function contactEditCheck(Request $request)
    ...
    public function editProcess($clientId,$contactId,Request $request)
    {
        ...
        $contact = Contact::where('id',$contactId)->first();
         ...
         if($request->file('fileToUpload') && $contactId)
                {
                     if (File::exists('../public_html/uploads/contactPics/'.$contactId.'.jpg'))
                         File::delete('../public_html/uploads/contactPics/'.$contactId.'.jpg');
